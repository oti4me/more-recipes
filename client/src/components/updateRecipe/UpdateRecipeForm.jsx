  ...
  getData() {
    ...
    axios.get('/api/v1/recipes/' + id, header())
      .then(res => {
        ...
        const { title, ingredients, direction, description, image } = res.data.recipe;
        // this.setState({
        //   title,
        //   ingredients,
        //   direction,
        ...
        <div className="col s12 m4 l4 ">
          ...
          <div className="file-field input-field col s12" >
            <div className="btn color-dark-gray">
              <span>Image</span>
              <input id="img" type="file" multiple name="image" value={this.state.image} onChange={this.handleChange.bind(this)} />
            </div>
