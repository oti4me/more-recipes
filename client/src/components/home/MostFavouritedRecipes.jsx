...
import getFavouritedRecipes from '../../actions/getMostFavouritedRecipes';

/**
 * 
 * @class MostFavouritedRecipes
 * 
 * @extends {Component}
 */
export class MostFavouritedRecipes extends Component {
   ...
   * @param {object} props 
   * 
   * @memberof MostFavouritedRecipes
   */
  constructor(props) {
    super(props);
    this.state = {
  ...
  /**
   * @description creates a list of recipe to be displayed
   * 
  ...
  /**
   * @description A method to show the user a notification if no recipe is found
   * 
   * @returns {object} JSX object
   * 
   * @memberof MostFavouritedRecipes
...
const mapStateToProps = (state) => {
  return {
    ...
    recipes: state.recipes.favouritedRecipes,
  };
}
...
export default connect(mapStateToProps, mapDispatchToProps)(MostFavouritedRecipes);
